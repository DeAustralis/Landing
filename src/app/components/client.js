...
export default function Client() {
    // Ensure review has a default value
    const data = review || [];
                                    ...
                                    <div className="tiny-slide" key={index}>
                                        <div className="text-center">
                                            ...
                                            <div className="text-center mt-5">
                                                ...
                                                <Image src={el.profile} className="h-14 w-14 rounded-full shadow-md dark:shadow-gray-700 mx-auto" alt={el.name} height={56} width={56} priority />
